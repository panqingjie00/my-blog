...
<img src="./images/osi1.png" alt="osi1.png" style="zoom:60%;cursor:zoom-in"  data-fancybox="gallery"/>
...
<img src="./images/osi2.png" alt="osi2.png" style="zoom:60%;cursor:zoom-in"  data-fancybox="gallery"/>

## 数据的封装和解封装

<img src="./images/osi3.png" alt="osi3.png" style="zoom:60%;cursor:zoom-in"  data-fancybox="gallery"/>

## 四层、五层、七层

<img src="./images/osi4.png" alt="osi4.png" style="zoom:60%;cursor:zoom-in"  data-fancybox="gallery"/>
...
> 其中：
>
> 应用层主要面向互联网中的应用场景，比如网页、邮件、文件共享等等，它的代表协议有 http、smtp、pop3、ftp、DNS 等等
>
