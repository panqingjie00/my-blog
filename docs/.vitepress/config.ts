...
export default defineConfig({
    themeConfig: {
        ...
        // 顶部栏导航栏
        nav: [
            { text: '前端基础', link: '/basis/', activeMatch: '/basis/' },
            { text: '工程化', link: '/project/', activeMatch: '/project/' },
            { text: '可视化', link: 'https://github.com/...' },
            { text: '资源合集', link: 'https://github.com/...' },
        ],
